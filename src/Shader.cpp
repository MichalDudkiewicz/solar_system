...
void Shader::SetUniform4d(const std::string& name, double f0, double f1, double f2, double f3)
{
    GLCall( glUniform4f(GetUniformLocation(name), f0, f1, f2, f3) );
}

void Shader::SetUniform3f(const std::string& name, double f0, double f1, double f2)
{
